...
public class RentalRepositoryImpl implements RentalRepository {
	...
	private void initData () {
		data.clear();
		nextId = 1;
		save(new Rental(userRepo.findById(1L).get(), movieRepo.findById(1L).get(), 14, LocalDate.of(2021, Month.SEPTEMBER, 21)));
		save(new Rental(userRepo.findById(1L).get(), movieRepo.findById(2L).get(), 14, LocalDate.of(2021, Month.SEPTEMBER, 23)));
		save(new Rental(userRepo.findById(3L).get(), movieRepo.findById(3L).get(), 14, LocalDate.of(2021, Month.SEPTEMBER, 18)));
	}
